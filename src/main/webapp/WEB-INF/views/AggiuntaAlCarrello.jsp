...
<br><br>
<div style="text-align:center"> <img width="20%" src="https://i.imgur.com/MJWQJds.png"> </div>
<br><br><br>
<div class="vuoto" style="text-align: center; font-weight:bold; font-size:25px">Prodotto aggiunto al carrello</div>
<br><br><br>

<div style="text-align:center; width:50%; float:left"> <a href="Prodotti"><button class="hello" style="margin-left:70px;margin-right: 20px;height: 50px;text-align: center; font-weight:bold; border-radius:30px;transition-duration: 0.3s;"><img width="20" src="https://cdn2.iconfinder.com/data/icons/arrows-1-2/416/Arrow_Left3-512.png"> PAGINA PRODOTTI</button></a></div>
<div style="text-align:center; width:50%; float:right"> <a href="carrello"><button class="hello" style="margin-right:70px;height: 50px;text-align: center; font-weight:bold; border-radius:30px;transition-duration: 0.3s;"><img style="margin-top:-5px" width="20" src="https://image.flaticon.com/icons/png/512/263/263142.png"> VAI AL CARRELLO</button></a></div>
</div><br><br><br>
