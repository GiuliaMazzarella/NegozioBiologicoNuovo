...
<%--<%List<Carrello> carrello = (List<Carrello>) request.getAttribute("verifica");%>--%>
...
<div class="contenuto">
    ...
    <div class="dettagliProdotto">
        ...
        <div id="quantit"> <b>Disponibilità: </b><%=prodotti.getQuantitaProdotto()%></div>
...
<div style="width:100%; background:green; color: black; padding: 30px;  background: linear-gradient(to top, #4CAF50 50%, white );"> © Tutti i diritti riservati. Team Red S.r.l.  - Via Generation, 27 - Bari(BA) - Gaetano Di Rocco, Pierfrancesco Di Tommaso, Simone Giunta, Giulia Mazzarella - </div>
